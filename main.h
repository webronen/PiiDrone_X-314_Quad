...
#define PID_AUTOTUNE_CROSSES 6
#define PID_AUTOTUNE_FREQUENCY 1.0f
#define PID_AUTOTUNE_INCREMENT 0.2f
#define PID_AUTOTUNE_AMPLITUDE 20.0f
#define PID_AUTOTUNE_HYSTERESIS (0.5f / PID_AUTOTUNE_AMPLITUDE)
