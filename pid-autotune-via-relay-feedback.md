...
- **P stage:** Start at 0, increment by 0.5 up to 15.0. Advance if RMS < 0.12 (~6.9°) or max.
- **D stage:** Start at 0, increment by 0.2 up to 3.0. Advance if RMS < 0.08 (~4.6°) or max.
- **I stage:** Start at 0, increment by 0.1 up to 2.0. Finish if RMS < 0.06 (~3.4°) or max.
